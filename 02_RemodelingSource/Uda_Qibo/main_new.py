...
import helper_new as helper_cityscapes
import warnings
import math
...
def train_nn(sess, epochs, batch_size, get_train_batches_fn, get_valid_batches_fn, train_op, cross_entropy_loss,
    ...
    for epoch in range(epochs):
        ...
        helper_cityscapes.plot_loss(RUNS_DIR, losses, "loss_graph_training")
        ...
        for image, label in tqdm(generator, total=n_valid, desc=description, unit='batches'):
            ...
            losses.append(loss)
            ious.append(sess.run(iou))
        helper_cityscapes.plot_loss(RUNS_DIR, losses, "loss_graph_validation")
